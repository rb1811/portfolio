...
def load_projects_data() -> typing.List[ProjectData]:
    ...
    # 2. Map 'languages_used' to 'tech_stack' for rendering
    print("--- DEBUGGING PROJECT DATA LOAD ---")
    for project in processed_projects:
        # Explicitly set tech_stack to languages_used
        project.tech_stack = project.languages_used
        print(f"Project '{project.title}': Tech Stack mapped from languages_used (Count: {len(project.tech_stack)})")
    print("-----------------------------------")
    ...
    return rx.dialog.root(
        ...
        rx.dialog.content(
            ...
            rx.vstack(
                ...
                width="100%",
                padding="0", # Reset internal padding since it's handled by padding_x in children
            ),
...
def project_card(project: rx.Var[ProjectData]) -> rx.Component:
    ...
    return rx.vstack(
        ...
        rx.box(
            ...
            # --- CRITICAL FIX: Consistent Padding Applied to the Wrapper ---
            width="100%",
